  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-6">
      <div className="bg-vw-panel border border-gray-700 rounded-2xl p-8 max-w-sm w-full text-center shadow-2xl">
        ...
        <p className="text-gray-300 mb-8 leading-relaxed">Pro funkci vodováhy potřebuje aplikace přístup ke gyroskopu vašeho iPhone.</p>
        <button
          onClick={onGrant}
        ...
        <p className="mt-4 text-xs text-gray-500">Klikněte a v dialogovém okně zvolte "Povolit" (Allow).</p>
      </div>
    </div>
  );
};
