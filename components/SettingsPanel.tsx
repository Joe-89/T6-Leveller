      ...
      <div className="bg-vw-panel p-4 rounded-xl border border-gray-700">
        ...
        <div className="flex bg-gray-900 rounded-lg p-1 h-14">
            <button 
                ...
                className={`flex-1 flex flex-col items-center justify-center rounded-md transition-all ${currentWheelbase === Wheelbase.SHORT ? 'bg-gray-700 text-white shadow' : 'text-gray-500 hover:text-gray-300'}`}
            >
            ...
            <button 
                ...
                className={`flex-1 flex flex-col items-center justify-center rounded-md transition-all ${currentWheelbase === Wheelbase.LONG ? 'bg-gray-700 text-white shadow' : 'text-gray-500 hover:text-gray-300'}`}
            >
      ...
      <div className="bg-vw-panel p-4 rounded-xl border border-gray-700 flex flex-col gap-2 justify-center relative">
        ...
        {showInfo && (
            <div className="absolute bottom-[calc(100%+10px)] right-0 left-[-50px] bg-gray-800 text-xs text-gray-200 p-3 rounded-lg border border-gray-600 shadow-xl z-30 animate-fade-in-up">
                <p className="leading-tight">
                    Položte telefon na pevnou plochu v autě (např. kuchyňka). Stisknutím tlačítka nastavíte aktuální náklon jako "rovinu".
                </p>
        ...
        <div className="flex gap-2">
            ...
            <button
                ...
                className={`w-10 flex items-center justify-center rounded-lg border transition-colors ${showInfo ? 'bg-vw-accent text-white border-vw-accent' : 'bg-gray-800 hover:bg-gray-700 text-gray-400 border-gray-600'}`}
        ...
        <button 
            onClick={onReset}
            className="w-full text-gray-500 hover:text-white py-1 text-xs transition-colors"
        >
            Resetovat
        </button>
      </div>
